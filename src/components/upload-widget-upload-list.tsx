    ...
    <div className="px-3 flex flex-col gap-3">
      ...
      <ScrollArea.Root className="overflow-hidden">
        ...
        <ScrollArea.Scrollbar
          className="flex touch-none select-none bg-zinc-800 p-0.5 transition-colors duration-[160ms] ease-out hover:bg-zinc-500 data-[orientation=horizontal]:h-2.5 data-[orientation=vertical]:w-2.5 data-[orientation=horizontal]:flex-col"
